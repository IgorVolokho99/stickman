...
class StickFigureSprite(Sprite):
    def __init__(self, game):
        Sprite.__init__(self, game)
        self.image_left = [
            PhotoIgame(file="figure-L1.gif"),
            PhotoIgame(file="figure-L2.gif"),
            PhotoIgame(file="figure-L3.gif"),
        ]
        self.image_right = [
            PhotoIgame(file="figure-R1.gif"),
            PhotoIgame(file="figure-R2.gif"),
            PhotoIgame(file="figure-R3.gif"),
        ]
        self.image = game.canvas.create_imgae(200, 470, image=self.images_left[0], anchor='nw')
        self.x = -2
        self.y = 0
